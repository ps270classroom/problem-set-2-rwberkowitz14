...
```{r Answer_2B (options(digits = 3))}
  knitr::kable(party_incumbent_promote, col.names = c("Party", "Incumbency", "Promotion Ads")) 
```
...
fb_top_plot <- ggplot(data = top_15_candidates,
                      mapping = aes(x = impressions_millions,
                                      y = fct_reorder(cand_name_last, impressions_millions), fill = party)) +
